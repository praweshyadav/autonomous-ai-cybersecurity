...
def evaluate_model(
    ...
    print()
    print("=" * 80)
    print("EVALUATING ATTACK FAMILY CLASSIFIER")
    print("=" * 80)
    ...
    # --------------------------------------------------------
    # Convert target labels to numeric IDs
    # --------------------------------------------------------
    ...
    # Macro metrics
    #
    # Macro averaging gives every attack family equal
    ...
    print(
        f"Mean confidence   : "
        f"{max_probability.mean():.6f}"
    )

    print(
        f"Median confidence : "
        f"{np.median(max_probability):.6f}"
    )

    print(
        f"Min confidence    : "
        f"{max_probability.min():.6f}"
    )

    print(
        f"Max confidence    : "
        f"{max_probability.max():.6f}"
    )
...
def main():
    ...
    print()
    print("=" * 80)
    print("ATTACK FAMILY CLASSIFIER EVALUATION")
    print("=" * 80)
